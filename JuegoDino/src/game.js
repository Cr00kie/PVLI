import Gameplay from './scenes/maingame.js';
...
let config = {
    ...
    scene: [Mainmenu, Gameplay, Derrota], //Aquí metemos todas las escenas que tendrá nuestro juego (su clase, luego cambiaremos de una a otra mediante el id)
    physics: {  
        default: 'arcade', //Tenemos físicas simple, arcade
        arcade: { 
            gravity: { y: 500 }, //Tenemos gravedad, podemos modificarla para aumentar su fuera o disminuirla
